      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            <div className="bg-gray-100 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-200 dark:border-slate-700/50 transition-colors">
          ...
          <div>
            <div className="bg-gray-100 dark:bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-200 dark:border-slate-700/50 transition-colors">
              ...
              <div className="space-y-4">
                {[
                  { title: "Frontend Development", desc: "Building responsive and interactive..." },
                  { title: "Backend Development", desc: "Creating robust server-side..." },
                  { title: "Full Stack Solutions", desc: "Developing end-to-end web..." },
                  { title: "API Development", desc: "Designing and implementing RESTful..." },
                ].map((item, i) => (
        ...
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Technologies I Work With</h3>
          <p className="text-gray-600 dark:text-slate-400">Here are some of the technologies I use...</p>
        </div>
