const Contact = () => {
  return (
    <section
      id="contact"
      className="py-12 sm:py-20 px-4 sm:px-6 bg-white text-black dark:bg-slate-800/30 dark:text-white transition-colors duration-300"
    >
      <div className="container mx-auto max-w-4xl text-center">
        ...
        {/* Contact Card */}
        <div className="bg-gray-100 dark:bg-slate-800/40 backdrop-blur-sm rounded-2xl p-4 sm:p-8 md:p-12 border border-gray-200 dark:border-slate-700/40 mb-8 sm:mb-12 transition-colors duration-300">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 items-start text-left">
            {/* Left Info */}
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-gray-100 dark:bg-slate-800/40 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-slate-700/40 transition-colors duration-300"
            >
              <h4 className="font-semibold mb-2 text-sm sm:text-base">{title}</h4>
              <p className="text-gray-700 dark:text-slate-400 text-xs sm:text-sm">{desc}</p>
            </div>
          ))}
        </div>
      </div>
